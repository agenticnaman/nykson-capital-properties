      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="flex gap-4 p-4 rounded-xl bg-background shadow-md hover:shadow-lg transition">
          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            <div className="absolute -top-8 -left-8 card-premium p-4 w-32 bg-white/90 backdrop-blur-md rounded-xl shadow-lg">
            ...
            <div className="absolute -bottom-8 -right-8 card-premium p-4 w-36 bg-white/90 backdrop-blur-md rounded-xl shadow-lg">
              <div className="flex items-center gap-2">
